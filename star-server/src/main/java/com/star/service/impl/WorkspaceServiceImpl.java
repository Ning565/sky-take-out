...
import com.star.vo.BusinessDataVO;
import com.star.vo.DishOverViewVO;
import com.star.vo.OrderOverViewVO;
import com.star.vo.SetmealOverViewVO;
...
public class WorkspaceServiceImpl implements WorkspaceService {
    ...
    public BusinessDataVO getBusinessData(LocalDateTime begin, LocalDateTime end) {
        ...
        if(totalOrderCount != 0 && validOrderCount != 0){
            ...
            //平均客单价
            unitPrice = turnover.divide((BigDecimal.valueOf(validOrderCount)), BigDecimal.ROUND_HALF_UP);
        }
