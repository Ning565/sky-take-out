...
public class WeChatProperties {
    ...
    public void setPrivateKeyFilePath(String privateKeyFilePath) { this.privateKeyFilePath = privateKeyFilePath; }
    ...
    public void setWeChatPayCertFilePath(String weChatPayCertFilePath) { this.weChatPayCertFilePath = weChatPayCertFilePath; }
